...
const JobDetail = () => {
  ...
  return (
    <div className='bg-[#Ddf2d1]'>
    <div className=' container mx-auto '>
      <div className='w-full flex flex-col md:flex-row gap-10 '>
        {/* LEFT SIDE */}
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white  mt-6 px-5 py-10 md:px-10 shadow-md'>
        ...
        <div className='w-full md:w-1/3 2xl:w-2/4 p-5 mt-20 md:mt-0'>
          <p className='text-gray-900 font-semibold'>Similar Job Post</p>

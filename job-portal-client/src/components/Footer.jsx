      ...
      <div className=''>
        ...
        <div className='container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between '>
          <div className='w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start '>
            <TextInput
              styles='w-full flex-grow md:w-40 2xl:w-64 bg-gray-100 text-black sm:mr-4 md-2'
              type='email'
            ...
            <CustomButton
              title='Subscribe'
              containerStyles={
                "block bg-green-800 text-white px-5 py-2.5 text-md rounded hover:bg-green-700 focus:potline-none flex-col items-center mt-2"
              }
            />
          </div>
      ...
      <div className='bg-green-600'>
        <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
          <p className='text-black font-semibold text-sm text-center sm:text-left'>
            ...
            <a
              href='https://github.com/KashishAgrawal-2'
